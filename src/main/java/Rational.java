class Rational { 
    ...
    public boolean equals(Object x) {
        ...
        x2.simplestForm();
        if(numerator == x2.numerator && denominator == x2.denominator){
    ...
    public long compareTo(Object x) {
        ...
        if(numerator * x2.denominator > denominator * x2.numerator){
            return -1; // TODO: this needs to be modified.
        }
        else if(numerator * x2.denominator < denominator * x2.numerator){
            return 1;
        }
        else{
            return 0;
